...
export default class Home extends Component {
  ...
  getSocket() {
    // const socket = new WebSocket("ws://10.103.0.1:2333");
    // console.log(socket);
    // socket.on("connect", e => {
    //   console.log(e);
    // });
              ...
              <List
                ...
                renderItem={item => (
                  <List.Item
                    key={item.title}
                    actions={[
                      <IconText text={item.author} />,
                      <IconText
                        type="eye-o"
                        text={this.state.view}
                        clickBtn={this.clickBtn}
                      />,
                      <IconText type="like-o" text={this.state.like} />,
                      <IconText type="message" text={this.state.message} />
                    ]}
                    extra={
                      <img
                        width={125}
